...
public class Thongtinnguoidung extends AppCompatActivity {
    ...
    Button btnxacnhanthongtin, btntrove;
     String id_user = ""; // Biến để lưu trữ ID người dùng
...

        {
            ...
            btnxacnhanthongtin.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    String id_user = "8"; // Biến để lưu trữ ID người dùng
...
//    private void getIdFromApi() {
//        String url = Server.Dangnhap; // Thay thế URL_CỦA_API bằng URL thực tế của API để lấy ID
//
...
//                    String id  = jsonObject.getString("id") ; // Tên trường chứa ID trong phản hồi JSON từ API
//                    // Sử dụng giá trị ID nhận được ở đây
//                    id_user = id  ;
//
//                    // Tiếp tục các xử lý hoặc gọi phương thức EventButton() ở đây
//                    EventButton();
//                } catch (JSONException e) {
//                    e.printStackTrace();
//                    // Xử lý lỗi khi không thể phân tích phản hồi JSON hoặc không tìm thấy trường ID
//                }
//            }
//        }, new Response.ErrorListener() {
//            @Override
